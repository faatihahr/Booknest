					...
					<div class="module-body">
						<div class="control-group">
							<div class="controls row-fluid">
								<input class="span6" type="text" placeholder="Nama Pertama" name="first" value="{{ Request::old('first') }}" />
						...
						<div class="control-group">
							<div class="controls row-fluid">
								<input class="span4" type="number" placeholder="Absen" name="rollnumber" value="{{ Request::old('rollnumber') }}" />
